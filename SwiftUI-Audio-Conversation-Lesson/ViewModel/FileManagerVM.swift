...
class FileManagerVM {
    ...
    class func getFilenameFromURL(fileURL: String) -> String {
        let temp = fileURL.components(separatedBy: ".").first!
        let orignalName = temp.components(separatedBy: "/").last!
        let orginalFileType = fileURL.components(separatedBy: ".").last!
        return orignalName+"."+orginalFileType
    }
